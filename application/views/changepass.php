            ...
            <section>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <form id="formlogin" action="<?php echo base_url('member/change_pass').'/'.$_SESSION['key'];; ?>" method="post">
                            ...
                            <div class="button-container">
                                <button onclick="submitLogin()" class="logins" name="login"><span>Change</span></button>
                            </div>
